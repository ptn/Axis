...
import type { ColorLabelGroup, ColorLabelSources, ColorLabelImportResult } from '$lib/api/types';
...
vi.mock('$lib/editor/editor.svelte', () => ({ editor: { showToast: (t: string, a?: string) => showToast(t, a) } }));
