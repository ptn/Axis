<script lang="ts">
  import { editorNavigation } from '$lib/editor/editorClients.svelte';
...
<button class="axis-widget search" data-size={size} type="button" onclick={() => editorNavigation.openLibrary()} title="Search presets">
