...
<style>
  /* card frame (background, border, radius, shadow) comes from Dialog; this is the
     layout-only remainder of the old `.card` rule. */
  .hp { display: flex; flex-direction: column; min-height: 0; max-height: 86vh; padding: 0 16px 12px; }
