<script lang="ts">
  ...
  import { fmtNumber, paramUnit } from '$lib/ui/format';
  import type { Cell } from '$lib/device/grid';
  import { planConnect } from '$lib/device/gridRouting';
  import { blockHelp, helpSlugForPack, resetHelpCache } from '$lib/api/help';
  import { theme } from '$lib/platform/theme.svelte';
  import { setGridHover, clearGridHover } from './gridHover.svelte';
  import { resolveAxisGridMetrics, resolveAxisGridPresentation, type AxisGridView } from '$lib/axis-workbench/gridView';
