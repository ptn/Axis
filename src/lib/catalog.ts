...
const CATALOG: Record<string, CatEntry> = {
  ...
  Delay: { accent: '#4a82e0', glyph: svg('<path d="M2.7 12c1.8-3.4 3.6-3.4 5.4 0s3.6 3.4 5.4 0 3.6-3.4 5.4 0"/><path d="M6.5 12c1.8-3.4 3.6-3.4 5.4 0s3.6 3.4 5.4 0 3.6-3.4 5.4 0" opacity=".4"/>'), short: 'Delay' },
  Multitap: { accent: '#4a82e0', glyph: MULTITAP_GLYPH, short: 'Multi' },
  Reverb: { accent: '#3fa890', glyph: svg('<path d="M3 21V15L5 9 7 13H10L12 3 14 13H17L19 9 21 15V21Z"/><path d="M9.5 21v-2.6L12 15.7l2.5 2.7V21"/><circle cx="12" cy="10.3" r="1.2"/><path d="M12 1v1.3M11.2 2h1.6"/>', 'fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"'), short: 'Reverb' },
