...
<style>
  ...
  .body { font-size: 13px; line-height: 1.5; color: var(--text2); }
  ...
  .sp { flex: 1; }
  .skip { background: none; border: none; color: var(--textdim); font-size: 12px; font-weight: 600; cursor: pointer; padding: 0; }
