...
- [ ] **Mute chip + ⋯ More menu** (Change block type… / Remove from grid → `onClose`) — confirm the panelized editor exposes Mute/Remove in the toolbar as specced, and that Remove routes through the workbench close.
